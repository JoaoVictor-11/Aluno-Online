...
public class MatriculaAlunoService {
    ...
    public void atualizarNotas (Long id, AtualizarNotasRequestDTO dto) {
        ...
        // 1 - Buscar matricula (mesmo padrão do trancar)
        ...
        // 3 - Se as duas notas existem, calcula média e define status
        ...
        // 4 - Salvar a matricula atualizada
        matriculaAlunoRepository.save(matricula);
    }

    public void criarMatricula(MatriculaAluno matriculaAluno) {
        matriculaAluno.setStatus(MatriculaAlunoStatusEnum.MATRCULADO);
        matriculaAlunoRepository.save(matriculaAluno);
    }

    public void trancarMatrícula(Long id) {

        // 1 - Buscar Matricula antes de atualizar, se não existe - 404 (NOT FOUND)
        ...
        if (matriculaAluno.getStatus()
                .equals(MatriculaAlunoStatusEnum.MATRCULADO)) {
